...
<body>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT ID, seatPosition, startPos, endPos, ticketMoney, totalsit, remainsit, `DATE`, `time` FROM ticketinfo" UpdateCommand="update ticketinfo
set ticketMoney = @ticketMoney 
    ...
    <asp:ListView ID="ListView1" runat="server" DataKeyNames="ID" 
        ...
        <AlternatingItemTemplate>
            <tr style="background-color: #FFFFFF;color: #284775;">
                ...
                <td>
                    <asp:Label ID="seatPositionLabel" runat="server" 
                        Text='<%# Eval("seatPosition") %>' />
                </td>
                <td>
        ...
        <EditItemTemplate>
            <tr style="background-color: #999999;">
                ...
                <td>
                    <asp:TextBox ID="seatPositionTextBox" runat="server" 
                        Text='<%# Bind("seatPosition") %>' />
                </td>
                <td>
